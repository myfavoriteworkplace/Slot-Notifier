...
The remaining release gate is the read-only production-clinic baseline. The Admin UI does not authorize plan changes, create Trial records, change subscription state, call payment providers, issue warnings, or enforce limits.