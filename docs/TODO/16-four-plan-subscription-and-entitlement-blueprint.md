...
This slice intentionally does not implement automatic initial-Trial creation, paid-expiry recovery, warning mode, or server-side enforcement. The next lifecycle slice is automatic Trial/recovery transition handling; the production baseline remains a release gate before enabling it against live clinics.
...
- automatic initial-Trial creation and paid-expiry recovery;
